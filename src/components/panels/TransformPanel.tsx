        ...
        {selectedBone ? (
          <>
            <div className="text-sm text-gray-300">
              Selected:{' '}
              <span className="font-mono text-white">{selectedBone}</span>
            </div>
          ...
          <div className="text-sm text-gray-500 italic">No bone selected</div>
        )}

        <div className="border-t border-gray-700 my-2" />

        <Button variant="ghost" size="sm" onClick={onResetAllBones}>
          Reset All Bones
        </Button>
      </div>
    </Panel>
