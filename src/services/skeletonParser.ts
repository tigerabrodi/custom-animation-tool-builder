 ...
 */
export function parseSkeletonFromScene(scene: THREE.Object3D): ParsedSkeleton | null {
 ...
 */
export function extractBindPose(bones: Map<BoneName, THREE.Bone>): Record<BoneName, BoneTransform> {
 ...
 */
export function validateSkeleton(bones: Map<BoneName, THREE.Bone>): { valid: boolean; missing: BoneName[] } {
 ...
 */
export function getBoneByName(skeleton: ParsedSkeleton, boneName: BoneName): THREE.Bone | undefined {
